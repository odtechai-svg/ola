...
const dictionaries: Dictionaries = {
  en: {
    ...
    "hero.subtitle": "Train your brain and tongue at the same time. 300 words. 15 minutes a day. Real speech.",
    ...
    "precision.title1": "Your tongue is a muscle.",
    "precision.title2": "Train it like one.",
    "precision.desc": "The more repetitions, the greater the retention. We recommend repeating each studied phrase 3 times.",
    ...
    "stats.days_done": "Days Completed",
    ...
    "settings.security_desc": "Change your account password.",
    ...
    "auth.reset_sent": "If this email is registered, you'll receive a reset link. Check your inbox.",
    ...
    "neuro.title": "The neuroscience of learning applied to your biological cycle.",
    "neuro.desc": "Don't study more, study at your peak hours. Align with the moments your brain is naturally programmed to memorize and retain information.",
    ...
    // ── Feedback & Ecosystem ──
    "feedback.badge": "Community & Support",
    "feedback.title": "Help us improve OLA",
    "feedback.desc": "OLA is a 100% free digital charity project. Your opinions, bug reports, and suggestions are essential for us to keep evolving!",
    "feedback.direct_channel": "Direct Channel",
    "feedback.direct_desc": "Prefer sending an email directly? Reach us at",
    "feedback.select_type": "Select feedback type",
    "feedback.cat.bug": "Report Bug",
    "feedback.cat.suggestion": "Suggestion",
    "feedback.cat.opinion": "Opinion",
    "feedback.cat.feature": "New Feature",
    "feedback.message_label": "Your message / feedback",
    "feedback.placeholder": "Describe the bug, suggestion or improvement you would like to see...",
    ...
    "feedback.success.desc": "Your message has been sent directly to our team at contato@odtechai.com.",
    "feedback.send_another": "Send another message",
    "ecosystem.badge": "Digital Charity • Free Forever",
    "ecosystem.title": "Where we test AI in things we don't sell.",
    "ecosystem.subtitle": "OLAlíngua, Fluxo Vital 369 and Trilha da Consciência were born outside B2B — they are our applied AI playground, open and free to transform lives.",
    "ecosystem.free": "Free",
    "ecosystem.education": "Education",
    "ecosystem.health": "Health",
    "ecosystem.human_dev": "Human Dev",
    "ecosystem.olalingua.desc": "Language learning with proprietary methodology, real-time speech and AI phonetic evaluation. Free forever.",
    "ecosystem.fluxo.desc": "Human physiology and circadian intelligence for real life: anamnesis, monitoring and three pillars — nutrition, exercise and sleep.",
    "ecosystem.trilha.desc": "Support platform for the trajectory of expansion of consciousness — structured content, welcoming, open and free forever.",
    "odtech.title": "Need a custom AI application, SaaS or information system?",
    "odtech.desc": "ODTech AI specializes in converting operational data into active applications: conversational dashboards (BIcomIA), semantic search, autonomous agents and complete platforms.",
    "odtech.cta_main": "Discover ODTech AI",
    "odtech.cta_contact": "Talk about B2B projects",
  },
  pt: {
    // ── Feedback & Ecosystem ──
    "feedback.badge": "Apoio & Comunidade",
    "feedback.title": "Ajude a melhorar o OLA",
    "feedback.desc": "O OLA é um projeto de caridade digital 100% gratuito. Suas opiniões, relatos de erros (bugs) e sugestões de melhoria são essenciais para continuarmos evoluindo!",
    "feedback.direct_channel": "Canal Direto",
    "feedback.direct_desc": "Prefere enviar um e-mail diretamente? Escreva para",
    "feedback.select_type": "Selecione o tipo de mensagem",
    "feedback.cat.bug": "Reportar Bug",
    "feedback.cat.suggestion": "Sugestão",
    "feedback.cat.opinion": "Opinião",
    "feedback.cat.feature": "Nova Função",
    "feedback.message_label": "Sua mensagem / feedback",
    "feedback.placeholder": "Descreva o bug encontrado, sugestão de melhoria ou sua opinião sobre a ferramenta...",
    "feedback.name_label": "Seu Nome",
    "feedback.email_label": "Seu E-mail",
    "feedback.optional": "opcional",
    "feedback.submit_button": "Enviar Feedback",
    "feedback.sending": "Enviando...",
    "feedback.success.title": "Muito obrigado pela colaboração!",
    "feedback.success.desc": "Sua mensagem foi enviada diretamente para a nossa equipe no e-mail contato@odtechai.com.",
    "feedback.send_another": "Enviar outra mensagem",
    "ecosystem.badge": "Caridade Digital • Gratuito para Sempre",
    "ecosystem.title": "Onde testamos IA em coisas que não vendemos.",
    "ecosystem.subtitle": "OLAlíngua, Fluxo Vital 369 e Trilha da Consciência nasceram fora do B2B — são o nosso playground de IA aplicada, aberto e gratuito para transformar vidas.",
    "ecosystem.free": "Gratuito",
    "ecosystem.education": "Educação",
    "ecosystem.health": "Saúde",
    "ecosystem.human_dev": "Desenvolvimento Humano",
    "ecosystem.olalingua.desc": "Aprendizado de idiomas com metodologia própria, fala em tempo real e avaliação fonética por IA. Gratuito para sempre.",
    "ecosystem.fluxo.desc": "Fisiologia humana e inteligência circadiana para a vida real: anamnese, monitoramento e três pilares — nutrição, exercício e sono.",
    "ecosystem.trilha.desc": "Plataforma de apoio à trajetória de expansão da consciência — conteúdo estruturado, acolhedor, aberto e gratuito para sempre.",
    "odtech.title": "Precisa de um sistema, SaaS ou aplicação sob medida com Inteligência Artificial?",
    "odtech.desc": "A ODTech AI é especialista em transformar dados operacionais em aplicações ativas: dashboards conversacionais (BIcomIA), busca semântica, agentes inteligentes e plataformas completas.",
    "odtech.cta_main": "Conhecer a ODTech AI",
    "odtech.cta_contact": "Falar sobre projetos B2B",
    ...
    "hero.subtitle": "Treine o seu cérebro e a sua língua ao mesmo tempo. 300 palavras. 15 minutos por dia. Fala real.",
    ...
    "precision.title1": "Sua língua é um músculo.",
    "precision.title2": "Treine como tal.",
    "precision.desc": "Quanto mais repetições, maior a fixação. Recomendamos repetir 3x cada frase estudada.",
    ...
    "session.continue": "Voltar ao início",
    "session.next_block": "Próximo Bloco",
    ...
    "stats.days_done": "Dias concluídos",
    ...
    "settings.security_desc": "Altere a senha da sua conta.",
    ...
    "settings.password_changed": "Senha atualizada!",
    "auth.forgot_password": "Esqueceu sua senha?",
    "auth.send_reset_link": "Enviar link de recuperação",
    "auth.reset_sent": "Se esse e-mail estiver cadastrado, você receberá um link de recuperação. Verifique sua caixa de entrada.",
    ...
    "neuro.title": "A neurociência do aprendizado aplicada ao seu ciclo biológico.",
    "neuro.desc": "Não estude mais, estude no seu horário de pico. Se alinhe aos momentos que seu cérebro está naturalmente programado para memorizar e reter informações.",
  ...
  es: {
    ...
    "hero.subtitle": "Entrena tu cerebro y tu lengua al mismo tiempo. 300 palabras. 15 minutos al día. Habla real.",
    ...
    "precision.title1": "Tu lengua es un músculo.",
    "precision.title2": "Entrénala como tal.",
    "precision.desc": "Cuantas más repeticiones, mayor es la fijación. Recomendamos repetir 3 veces cada frase estudiada.",
    ...
    "session.continue": "Volver al inicio",
    ...
    "stats.days_done": "Días completados",
    ...
    "settings.security_desc": "Cambia la contraseña de tu cuenta.",
    ...
    "settings.password_changed": "¡Contraseña actualizada!",
    "auth.forgot_password": "¿Olvidaste tu contraseña?",
    "auth.send_reset_link": "Enviar enlace de recuperación",
    "auth.reset_sent": "Si este correo está registrado, recibirás un enlace de recuperación. Revisa tu bandeja de entrada.",
    ...
    "neuro.title": "La neurociencia del aprendizaje aplicada a tu ciclo biológico.",
    "neuro.desc": "No estudies más, estudia en tu hora pico. Alinéate con los momentos en que tu cerebro está naturalmente programado para memorizar y retener información.",
  ...
  it: {
    ...
    "hero.subtitle": "Allena il tuo cervello e la tua lingua allo stesso tempo. 300 parole. 15 minuti al giorno. Parlato reale.",
    ...
    "precision.title1": "La tua lingua è un muscolo.",
    "precision.title2": "Allenala come tale.",
    "precision.desc": "Più ripetizioni fai, maggiore è la fissazione. Ti consigliamo di ripetere 3 volte ogni frase studiata.",
    ...
    "session.continue": "Torna all'inizio",
    "session.next_block": "Blocco Successivo",
    ...
    "stats.days_done": "Giorni completati",
    ...
    "settings.security_desc": "Cambia la password del tuo account.",
    ...
    "settings.password_changed": "Password aggiornata!",
    "auth.forgot_password": "Hai dimenticato la password?",
    "auth.send_reset_link": "Invia link di ripristino",
    "auth.reset_sent": "Se questa email è registrata, riceverai un link per reimpostare la password. Controlla la tua casella di posta.",
    ...
    "neuro.title": "La neuroscienza dell'apprendimento applicata al tuo ciclo biologico.",
    "neuro.desc": "Non studiare di più, studia nella tua ora di punta. Allineati ai momenti in cui il tuo cervello è naturalmente programmato per memorizzare e trattenere le informazioni.",
  ...
  fr: {
    ...
    "hero.subtitle": "Entraîne ton cerveau et ta langue en même temps. 300 mots. 15 minutes par jour. Parole réelle.",
    ...
    "precision.title1": "Ta langue est un muscle.",
    "precision.title2": "Entraîne-la comme tel.",
    "precision.desc": "Plus vous répétez, plus la fixation est grande. Nous recommandons de répéter 3 fois chaque phrase étudiée.",
    ...
    "session.continue": "Retour à l'accueil",
    ...
    "stats.days_done": "Jours complétés",
    ...
    "settings.security_desc": "Changez le mot de passe de votre compte.",
    ...
    "auth.reset_sent": "Si cet email est enregistré, vous recevrez un lien de réinitialisation. Vérifiez votre boîte de réception.",
    ...
    "neuro.title": "La neuroscience de l'apprentissage appliquée à votre cycle biologique.",
    "neuro.desc": "N'étudiez pas plus, étudiez à votre heure de pointe. Alignez-vous sur les moments où votre cerveau est naturellement programmé pour mémoriser et retenir les informations.",
  ...
  de: {
    ...
    "hero.subtitle": "Trainiere dein Gehirn und deine Zunge gleichzeitig. 300 Wörter. 15 Minuten am Tag. Echtes Sprechen.",
    ...
    "precision.title1": "Deine Zunge ist ein Muskel.",
    "precision.title2": "Trainiere ihn entsprechend.",
    "precision.desc": "Je mehr Wiederholungen, desto größer die Verankerung. Wir empfehlen, jeden gelernten Satz 3 Mal zu wiederholen.",
    ...
    "session.continue": "Zurück zur Startseite",
    "session.next_block": "Nächster Block",
    ...
    "stats.days_done": "Abgeschlossene Tage",
    ...
    "settings.security_desc": "Ändern Sie Ihr Kontopasswort.",
    ...
    "settings.password_changed": "Passwort aktualisiert!",
    "auth.forgot_password": "Passwort vergessen?",
    "auth.send_reset_link": "Link zum Zurücksetzen senden",
    "auth.reset_sent": "Wenn diese E-Mail registriert ist, erhalten Sie einen Link zum Zurücksetzen. Überprüfen Sie Ihren Posteingang.",
    ...
    "neuro.title": "Die Neurowissenschaft des Lernens angewendet auf Ihren biologischen Zyklus.",
    "neuro.desc": "Lernen Sie nicht mehr, lernen Sie zu Ihrer Spitzenzeit. Richten Sie sich auf die Momente aus, in denen Ihr Gehirn natürlich darauf programmiert ist, Informationen zu speichern und zu behalten.",
